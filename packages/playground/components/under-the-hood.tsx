...
import {
  UNDER_THE_HOOD_TITLE,
  UNDER_THE_HOOD_SUBTITLE,
  ACCORDION_ITEMS,
} from "@/lib/constants/ui-content";
...
export function UnderTheHood({ contractType }: UnderTheHoodProps) {
  ...
  const transformedCode =
    contractType === "ERC20" ? ERC20_CONTRACT_TRANSFORMED : ERC721_CONTRACT_TRANSFORMED;
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={containerRef}>
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem
              value="entrypoint"
              className="bg-gray-900/50 border-gray-700 rounded-lg px-6"
            >
            ...
            >
              ...
              <AccordionContent>
                <p className="text-gray-400 mb-4">
                  {ACCORDION_ITEMS.CONTRACT_TRANSFORMED.description}
                </p>
            ...
            <AccordionItem value="wasm" className="bg-gray-900/50 border-gray-700 rounded-lg px-6">
              ...
              <AccordionContent>
                <p className="text-gray-400 mb-4">
                  WebAssembly Text (WAT) format for better readability. The compiled binary versions
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gray-800 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-400 text-sm">
                        WebAssembly Binary • Optimized for deployment
                      </p>
                    </div>
                    <Button
