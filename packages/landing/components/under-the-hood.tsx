        ...
        <div ref={containerRef}>
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="entrypoint" className="bg-gray-900/50 border-gray-700 rounded-lg px-6">
              <AccordionTrigger className="text-white hover:text-blue-400">Generated entrypoint</AccordionTrigger>
              <AccordionContent>
                <p className="text-gray-400 mb-4">The main entry point that routes function calls based on selectors</p>
                <CodeBlock code={entrypointCode} language="typescript" />
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="selectors" className="bg-gray-900/50 border-gray-700 rounded-lg px-6">
              <AccordionTrigger className="text-white hover:text-blue-400">Selectors</AccordionTrigger>
              <AccordionContent>
                <p className="text-gray-400 mb-4">Function name to 4-byte selector mapping</p>
                <CodeBlock code={selectorsCode} language="json" />
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="wasm" className="bg-gray-900/50 border-gray-700 rounded-lg px-6">
              <AccordionTrigger className="text-white hover:text-blue-400">WASM artifact</AccordionTrigger>
              <AccordionContent>
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-800 rounded-lg">
                  ...
                  <button className="ml-auto text-blue-400 hover:text-blue-300">Download</button>
                </div>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
