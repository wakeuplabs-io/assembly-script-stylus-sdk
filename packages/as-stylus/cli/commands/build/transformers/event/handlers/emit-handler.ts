...
export class EventEmitHandler implements ExpressionHandler {
  ...
  handle(
    ...
    meta.fields.forEach((field, i) => {
      ...
      if (field.indexed) {
        setup.push(`U256.copy(${topicsTemp} + ${topicOffset}, ${argExpr.valueExpr});`);
        topicOffset += 32;
      } else {
