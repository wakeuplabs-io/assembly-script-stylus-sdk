...
export class ErrorManager {
  ...
  addSemanticError(code: string, location?: string, line?: number, args?: string[]): void {
    ...
    this.semanticErrors.push(
      new ValidationError(message, code, "semantic", location, line, numericCode),
    );
  }
  ...
  addSyntaxError(code: string, location?: string, line?: number, args?: string[]): void {
    ...
    this.syntaxErrors.push(
      new ValidationError(message, code, "syntax", location, line, numericCode),
    );
  }
  ...
  addSemanticErrorWithCode(
    ...
    this.semanticErrors.push(
      new ValidationError(errorMessage, ErrorCode[code], "semantic", location, line, code),
    );
  }
  ...
  addSyntaxErrorWithCode(
    ...
    this.syntaxErrors.push(
      new ValidationError(errorMessage, ErrorCode[code], "syntax", location, line, code),
    );
  }
  ...
  hasErrors(): boolean {
    return (
      this.semanticErrors.length > 0 ||
      this.syntaxErrors.length > 0 ||
      this.deploymentErrors.length > 0
    );
  }
