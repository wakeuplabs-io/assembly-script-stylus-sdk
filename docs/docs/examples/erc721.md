...
Un ejemplo completo de implementación ERC721 (NFT) usando AssemblyScript Stylus SDK.

## Estructura del Contrato

### Custom Errors
Errores específicos para diferentes validaciones:
...
### Approval Functions
Sistema de permisos para transferir NFTs:
...
### Transfer Function
Transfiere NFTs entre cuentas con validaciones completas:
...
### Mint & Burn
Funciones para crear y destruir NFTs:
...
### View Functions
Métodos de consulta para información del NFT:
